_ace_settings = [ 
	...
	["ace_medical_medicSetting", 1], /*Medic info (2 = advanced)*/
	...
	["ace_medical_medicSetting_PAK", 0], /*Who can use PAK (1 = medic onlt, 2 = doctor only, (0 = anyone??) )*/
	["ace_medical_consumeItem_PAK", 0], /*Remove PAK on use (-1 = no)*/
	["ace_medical_useCondition_PAK", 0], /*Condition at which PAK can be used ( 1 = stable, other: anytime )*/
	["ace_medical_useLocation_PAK", 0], /*PAK use location (-1 = anywhere, 1 = medical vehicle)*/
